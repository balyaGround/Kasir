...
<head>
    ...
    <!-- my style -->
    <link rel="stylesheet" href="{{asset('original-asset/Kasir/mystyle.css')}}">
...
<nav class="navbar navbar-light">
    <a class="navbar-brand" href="#">
        <img src="{{asset('original-asset/Kasir/img/logo.png')}}" width="300" height="119.45" alt="">
    </a>
</nav>
...
<div class="container-fluid h-100">
    <div class="row h-100 align-items-center">
        <div class="col-12 col-lg-7 content" >
            ...
            <p>Aplikasi kasir online punya lapak Bang Fay, memudahkan mengelola bisnis dari mana saja!!</p>
            <div class="row">
                ...
                <div class="col-12 col-lg-3" style="text-align: center;">
                    <a href="{{route('login')}}" class="btn kasir">Login Kasir</a>
                </div>
